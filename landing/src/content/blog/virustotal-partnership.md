---
title: "Zaki Partners with VirusTotal for Skill Security"
...
image: "/blog/zaki-virustotal.svg"
---

Today we're announcing a partnership with [VirusTotal](https://www.virustotal.com), the world's leading threat intelligence platform, to bring security scanning to ClawHub—Zaki's skill marketplace.

**TL;DR:** All skills published to ClawHub are now scanned using VirusTotal's threat intelligence, including their new Code Insight capability. This provides an additional layer of security for the Zaki community.
...
We understand that with the great utility of a tool like Zaki comes great responsibility. Done wrong, an AI agent is a liability. Done right, we can change personal computing for the better.

Zaki skills are powerful. They extend what your AI agent can do—from controlling smart home devices to managing finances to automating workflows. But with that power comes risk.
...
As the Zaki ecosystem grows, so does the attack surface. We've already seen [documented cases](https://blog.virustotal.com/2026/02/from-automation-to-infection-how.html) of malicious actors attempting to exploit AI agent platforms. We're not waiting for this to become a bigger problem.
...
This partnership is part of a broader security initiative at Zaki. In the coming days, we'll be publishing:

- **A comprehensive threat model** for the Zaki ecosystem
...
Follow progress and read the full security program overview at [trust.zaki.ai](https://trust.zaki.ai/).
...
We expect some false positives initially—security tooling isn't perfect. If your skill is incorrectly flagged, reach out to us at security@zaki.ai and we'll review it.
...
- Report suspicious behavior to security@zaki.ai

## Thank You, VirusTotal

We're grateful to Bernardo Quintero and the VirusTotal team for their partnership. Their platform protects millions of users every day, and we're proud to bring that protection to the Zaki community.

## What's Next

This is the beginning, not the end. We're committed to making Zaki the most secure AI agent platform available. Expect more announcements soon.

The lobster grows stronger. 🦞

---

*Questions about security? security@zaki.ai*
